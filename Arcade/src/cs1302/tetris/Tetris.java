...
public class Tetris{
	...
	public void gameover (boolean transparent) throws FileNotFoundException {
		if (HighScoreTable.isNewHighScore("src/cs1302/tetris/highscores.txt", scoreBoard.getScore(), 1)) {
			VBox entry = ScoreBoard.newHighScoreEntry("src/cs1302/tetris/highscores.txt", scoreBoard.getScore(), () -> {
	...
	private void highScoreTable (boolean transparent) throws FileNotFoundException {
		...
		HighScoreTable highscore_table = new HighScoreTable("src/cs1302/tetris/highscores.txt", 1);
